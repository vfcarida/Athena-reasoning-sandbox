<div align="center">
  ...
  <p>
    ...
    <a href="tests/"><img src="https://img.shields.io/badge/Tests-104%20passed-brightgreen?style=flat-square&logo=pytest" alt="Tests"></a>
...
graph TB
    ...
    subgraph Governance["4. FinOps AST Pre-Execution Guard"]
        ...
        Guard -->|Reject| Reflection["Multi-Turn Reflection Cycle"]
...
- The agent captures the AST error, appends a structured `<think>` reflection trace, autonomously repairs the SQL query, and re-executes across the Parallax boundary.

### 4. Dual-Lane Engineering Architecture
...
└── tests/                     # 104+ deterministic unit & integration tests
```
